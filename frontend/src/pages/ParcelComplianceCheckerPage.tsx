...
import ParcelComplianceChecker from '../components/ParcelComplianceChecker';
import AskSupplyBot from '../components/AskSupplyBot';
import Footer from '../components/Footer';
import { User, Wallet } from 'lucide-react';
import SimpleModal from '../components/SimpleModal';

const ParcelComplianceCheckerPage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-extrabold text-gray-900 mb-6 text-center">Parcel Compliance Checker</h1>
        <div className="bg-white shadow-lg rounded-lg p-6 sm:p-8 lg:p-10">
          <ParcelComplianceChecker />
        </div>
      </div>
      <AskSupplyBot />
      <Footer />
...
export default ParcelComplianceCheckerPage;