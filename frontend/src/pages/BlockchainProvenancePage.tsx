...
const BlockchainProvenancePage: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-extrabold text-gray-900 mb-6 text-center">Blockchain Provenance</h1>
...
export default BlockchainProvenancePage;